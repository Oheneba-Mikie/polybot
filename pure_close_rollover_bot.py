...
DOUBLE_STAKE         = False          # Set True to split stake into 2 parallel orders
...
def main():
    ...
    print(f"  Strategy: bet T-{BET_WINDOW_START}s->T-{BET_WINDOW_END}s | WIN rolls over | LOSS resets\n")
