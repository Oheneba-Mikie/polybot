...
print("="*95)
print("📡 LIVE REAL-TIME LOG STREAM (MONITORING ONLY - NO CODE CHANGES)")
print("="*95)

seen_logs = set()
end_time = time.time() + 45 # Monitor for 45 seconds
...
while time.time() < end_time:
    try:
        ...
        if new_logs:
            ...
            print(f"[{datetime.datetime.now().strftime('%H:%M:%S')}] Active: {cur_candle} | BTC: ${btc:.2f} | Strike: ${strike:.2f} | Gap: ${gap:.2f} | Bal: ${bal} | Phase: {phase}")
