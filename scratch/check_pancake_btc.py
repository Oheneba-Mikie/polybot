...
BTC_PREDICTION_BSC = "0x48781a7d35f6137a9135Bbb984AF65fd6AB25618"

# Function selector for currentEpoch(): 0x759c8695
payload_epoch = {
    "jsonrpc": "2.0",
    "method": "eth_call",
    "params": [{"to": BTC_PREDICTION_BSC, "data": "0x759c8695"}, "latest"],
    "id": 1
}
...
print("="*80)
print("🥞 LIVE PANCAKESWAP 5-MINUTE BTC/USD PREDICTION (BNB CHAIN):")
print("="*80)
print(f"Contract Address:   {BTC_PREDICTION_BSC}")
...
payload_round = {
    "jsonrpc": "2.0",
    "method": "eth_call",
    "params": [{"to": BTC_PREDICTION_BSC, "data": "0xd09de08a" + epoch_hex}, "latest"],
    "id": 2
}
