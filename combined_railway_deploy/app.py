"""
================================================================================
COMBINED GUARD RAIL CLOUD ENGINE & WEB DASHBOARD
================================================================================
Runs the Combined Guard Rail bot in a background thread and serves a live Flask
web dashboard for remote monitoring on Railway/Render.
================================================================================
"""
...
MIN_SAFE_BTC_GAP        = float(os.getenv("MIN_SAFE_BTC_GAP", "50.00"))
...
WS_HEADERS = {
    ...
    "User-Agent": "Mozilla/5.0 (Windows NT 10.0; Win64; x64) CombinedCloudBot/1.0"
}
...
def run_bot_engine():
    log("Starting Combined Guard Rail Bot Cloud Engine...")
    client = None
...
def fetch_blockchain_pnl_history():
    ...
    try:
        ...
        cur_bal = bot_state["balance"] if bot_state["balance"] > 0 else 7.60
        # Calculate backward or forward trajectory
        points = []
        for a in acts[-30:]:
